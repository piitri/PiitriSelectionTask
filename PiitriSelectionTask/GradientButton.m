...
- (void)useWhiteActionSheetStyle
{
	...
	[colors addObject:(id)[color CGColor]];
	color = [UIColor colorWithWhite:1.0f alpha:0.2f];
	[colors addObject:(id)[color CGColor]];
	color = [UIColor colorWithWhite:0.75f alpha:0.2f];
	[colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithWhite:0.4f alpha:0.2f];
	[colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithWhite:1.0f alpha:0.4f];
	[colors addObject:(id)[color CGColor]];
    self.normalGradientColors = colors;
    self.normalGradientLocations = [NSMutableArray arrayWithObjects:
                                    [NSNumber numberWithFloat:0.0f],
                                    ...
                                    nil];*/
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:4];
	UIColor *color = [UIColor colorWithRed:0.93 green:0.94 blue:0.95 alpha:1.0];
	[colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.93 green:0.94 blue:0.95 alpha:1.0];
	[colors addObject:(id)[color CGColor]];
